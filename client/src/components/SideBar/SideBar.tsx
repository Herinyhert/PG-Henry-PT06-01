        ...
        <div>
          ...
          <div>
            <button
              ...
              style={{ backgroundColor: homeState.order === "name" && homeState.direction === "asc" ? "lightblue" : "", margin: 5 }}>
              <TbSortAscendingLetters style={{ width: 30, height: 30 }} />
            </button>
            <button
              onClick={() => handlerchange("name", "desc")}
              style={{ backgroundColor: homeState.order === "name" && homeState.direction === "desc" ? "lightblue" : "", margin: 5 }}>
        ...
        <div>
          ...
          <div>
            <button
              ...
              style={{ backgroundColor: homeState.order === "price" && homeState.direction === "asc" ? "lightblue" : "", margin: 5 }}>
              <TbSortAscendingNumbers style={{ width: 30, height: 30 }} />
            </button>
            <button
              onClick={() => handlerchange("price", "desc")}
              style={{ backgroundColor: homeState.order === "price" && homeState.direction === "desc" ? "lightblue" : "", margin: 5 }}>
